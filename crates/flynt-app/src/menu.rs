//! Native menu bar for the Flynt desktop app.
//!
...
pub const OPEN_PROJECT: &str = "flynt-open-project";
...
pub const TOGGLE_AGENT: &str = "flynt-toggle-agent";
pub const TOGGLE_SIDEBAR: &str = "flynt-toggle-sidebar";

pub const SYNC_NOW: &str = "flynt-sync-now";
pub const NEW_BOARD: &str = "flynt-new-board";
...
pub fn build_menu_bar() -> Menu {
    ...
    // ── Flynt (app menu on macOS) ────────────────────────────────────────
    let app_menu = Submenu::new("Flynt", true);
    app_menu
        .append_items(&[

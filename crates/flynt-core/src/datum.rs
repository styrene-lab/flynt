//! Datum — the atomic typed value in Flynt.
//!
...
/// Atomic typed value — the irreducible unit of structured data in Flynt.
///
...
///
/// Every typed thing in Flynt — documents, tasks, projects, contacts — is an
...
/// org = "example-org"
/// default_branch = "main"
/// local_path = "/home/user/projects/flynt"
/// +++
/// ```
#[derive(Debug, Clone)]
...
mod tests {
    ...
    fn repo_view_from_entity() {
        let repo = Entity::new(EntityKind::Repo)
            ...
            .with_field("local_path", Datum::Text("/workspace/flynt".into()));

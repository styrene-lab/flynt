//! iCloud Drive sync for Codex vaults.
//!
...
//!
//! On macOS: ~/Library/Mobile Documents/com~apple~CloudDrive/Codex/
...
/// Get the default Codex vault path inside iCloud Drive.
...
"#
    ...
    std::fs::write(root.join(".codex/config.toml"), config)?;

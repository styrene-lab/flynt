        ...
        div { class: "graph-mobile",
            ...
            div { class: "graph-fab-group",
                if *controls_open.read() {
                    button { class: "graph-fab-btn", onclick: move |_| { document::eval("window._flyntGraphZoom&&window._flyntGraphZoom(1.5)"); }, span { class: "fab-icon", dangerous_inner_html: crate::icons::ICON_PLUS } }
                    button { class: "graph-fab-btn", onclick: move |_| { document::eval("window._flyntGraphZoom&&window._flyntGraphZoom(0.67)"); }, span { class: "fab-icon", dangerous_inner_html: crate::icons::ICON_MINUS } }
                    button { class: "graph-fab-btn", onclick: move |_| { document::eval("window._flyntGraphReset&&window._flyntGraphReset()"); }, span { class: "fab-icon", dangerous_inner_html: crate::icons::ICON_CROSSHAIR } }
                    button { class: "graph-fab-btn", onclick: move |_| { document::eval("window._flyntGraphReheat&&window._flyntGraphReheat()"); }, span { class: "fab-icon", dangerous_inner_html: crate::icons::ICON_REFRESH } }
                ...
                div { class: "graph-sheet",
                    ...
                    div { class: "gs-section",
                        ...
                        div { class: "gs-chips",
                            ...
                            for kind in [GraphNodeKind::Document, GraphNodeKind::Task, GraphNodeKind::Board, GraphNodeKind::Repo, GraphNodeKind::MemoryFact, GraphNodeKind::Communication, GraphNodeKind::DesignNode, GraphNodeKind::Scenario] {
                                {
...
function flyntGraph(data) {
  ...
  window._flyntGraphZoom=function(f){var rect=svg.getBoundingClientRect();var mx=rect.width/2,my=rect.height/2;var nz=Math.max(0.2,Math.min(6,zm*f));px=mx-(mx-px)*nz/zm;py=my-(my-py)*nz/zm;zm=nz;upd();};
  window._flyntGraphReset=function(){zm=1;px=0;py=0;upd();};
  window._flyntGraphReheat=function(){alpha=1.0;nodes.forEach(function(n){n.vx=(Math.random()-0.5)*2;n.vy=(Math.random()-0.5)*2;n._pinned=false;});};
  window._flyntGraphUpdate=function(newData){
